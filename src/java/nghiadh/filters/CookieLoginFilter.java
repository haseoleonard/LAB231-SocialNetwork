...
public class CookieLoginFilter implements Filter {
    private static final String HOME_PAGE = "ArticleListPage.jsp";
...
//        if (debug) {
//            log("CookieLoginFilter:DoBeforeProcessing");
//        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
//        if (debug) {
//            log("CookieLoginFilter:DoAfterProcessing");
//        }
...
//        if (debug) {
//            log("CookieLoginFilter:doFilter()");
//        }
...
//            if (debug) {                
//                log("CookieLoginFilter:Initializing filter");
//            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CookieLoginFilter()");
        }
        StringBuffer sb = new StringBuffer("CookieLoginFilter(");
