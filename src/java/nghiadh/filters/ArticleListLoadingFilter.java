...
public class ArticleListLoadingFilter implements Filter {
    ...
    public ArticleListLoadingFilter() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
//        if (debug) {
//            log("ArticleListLoadingFilter:DoBeforeProcessing");
//        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
//        if (debug) {
//            log("ArticleListLoadingFilter:DoAfterProcessing");
//        }
...
//        if (debug) {
//            log("ArticleListLoadingFilter:doFilter()");
//        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("ArticleListLoadingFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ArticleListLoadingFilter()");
        }
        StringBuffer sb = new StringBuffer("ArticleListLoadingFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("ArticleListLoadingFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("ArticleListLoadingFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("ArticleListLoadingFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("ArticleListLoadingFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("ArticleListLoadingFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
